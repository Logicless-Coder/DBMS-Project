...
app.get("/classwork/:id/:cid/:aid/", async (req, res) => {
	res.render("./student/create_homework.ejs", {
		id: req.params.id,
		cid: req.params.cid,
		aid: req.params.aid,
	});
...
app.get("/home-show/:cid/:id/", async (req, res) => {
	try {
		...
		res.render("./student/submitted_homework.ejs", {
			data: ad,
			cid: cid,
			id: req.params.id,
		});
...
app.get("/show-classmates/:cid/:uid", async (req, res) => {
	try {
		...
		res.render("./student/student_people", {
			data: data.students,
			cid: cid,
			id: req.params.uid,
			fc_name: name,
